...
- Work within your budget (a small turn cap and a wall-clock timeout): find the entry-point files from main_history, read them targeted, and STOP. Do not full-scan the repository.
